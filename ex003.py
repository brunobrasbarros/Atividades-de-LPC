...
if len(CpfCompleto) != 14:
        print("CPF INVALIDO POR QUANTIDADE DE CARACTERES, preencha os campos corretamente")

if digito.isdigit() == True:
        print("letras são inválidas na verificação de Cpf")

if len(CpfCompleto) == 14 and digito.isdigit == False:
    print(f"o Cpf ficou {PrimeiraParte}.{SegundaParte}.{TerceiraParte}-{QuartaParte}")